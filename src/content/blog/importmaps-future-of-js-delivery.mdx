...
<h2 slot="header">
  ...
  <slot>
    ...
    Why not use `importmap-rails`? Well, it famously does not, [nor will not](https://github.com/rails/importmap-rails/issues/124#issuecomment-1113969386), support Typescript. Luckily, it's not that hard to roll yourself using sprockets and esbuild.
  </slot>
</Aside>
