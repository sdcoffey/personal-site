...
<a href="/public/Resume.pdf" class="text-sm text-slate-500" target={"_blank"} rel={"noopener noreferrer"}>
  Get a PDF copy
</a>

I’m a founder and full-stack engineer with a decade of experience building for web and mobile. As a co-founder
of AssetClass, I built four greenfield products spanning AI, fintech, and travel. At Sonder, I increased repeat
bookings by 10% and elevated operational efficiency by 15% through the development of our mobile app and guest
messaging platform.
...
I'm currently exploring new roles. If you're interested in working with me, shoot me a note at [stevendcoffey@gmail.com](mailto:stevendcoffey@gmail.com).
